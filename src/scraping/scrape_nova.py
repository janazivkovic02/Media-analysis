...
class NovaScraper(BaseScraper):
    ...
    OUT_DIR = OUT_DIR / "nova"
    NAME = "Nova"
    NORMALIZE_TRAILING_SLASH = True

    def parse_nova_date(self, text: str):
    ...
    def extract_author_and_date(self, soup: BeautifulSoup):
        ...
        if time_tag and not published_date:
            ...
            if not published_date:
                published_date = self.parse_nova_date(time_tag.get_text(" ", strip=True))
